          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.accordionContainer}>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.accordionTitle}>How to Send messages to mobile users dealing in a specific product.</Text>
                <Icon
              ...
              {isExpanded && (
                <View style={styles.accordionContent}>
                  ...
                  <Text style={styles.accordionBullet}>
                    ● First edit / create message to be sent. Minimum 1 Count
