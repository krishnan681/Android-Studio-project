  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.bulletText}>
          ● For error free delivery of messages, send in batches of 10 nos. each time
        </Text>
      </View>
      ...
      {datas.map(item => (
        ...
        >
          <View style={styles.cardHeader}>
            <Text style={[styles.cardTitle, selectedBusinesses.includes(item) && styles.selectedCardTitle]}>
              {item.businessname || item.person}
            </Text>
          </View>
          <View style={styles.cardBody}>
            <Text style={styles.cardText}>📞 {item.mobileno.slice(0, -5)}xxxxx</Text>
          </View>
          <View style={styles.cardFooter}>
            <TouchableOpacity onPress={() => handleCheckboxChange(item)} style={styles.checkboxContainer}>
